		...
		Tables: {
			participants: {
				...
				Relationships: [
					...
					{
						foreignKeyName:
							'public_participants_shopping_list_id_fkey';
					...
					{
						foreignKeyName:
							'public_participants_user_profile_id_fkey';
			...
			shopping_items: {
				...
				Relationships: [
					...
					{
						foreignKeyName:
							'public_shopping_items_purchased_by_fkey';
					...
					{
						foreignKeyName:
							'public_shopping_items_shopping_list_id_fkey';
						columns: ['shopping_list_id'];
						isOneToOne: false;
						referencedRelation: 'shopping_lists';
						referencedColumns: ['id'];
